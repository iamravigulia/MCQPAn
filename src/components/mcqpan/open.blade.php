<div>
    ...
    <form action="{{route('fmt.mcqpan.store')}}" method="post" class="fmt_box" enctype="multipart/form-data">
        ...
        <div class="fmt_headline">Add a MCQPAn</div>
        <div>
        ...
        <div class="fmt_flex">
            <div>
                ...
                <input style="margin-top:10px;" type="file" accept="image/*" name="answer_1_media" id=""required>
            </div>
            <div>
        ...
        <div class="fmt_flex">
            <div>
                ...
                <input style="margin-top:10px;" type="file" accept="image/*" name="answer_2_media" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            <div>
                ...
                <input style="margin-top:10px;" type="file" accept="image/*" name="answer_3_media" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            <div>
                ...
                <input style="margin-top:10px;" type="file" accept="image/*" name="answer_4_media" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            <div>
                ...
                <input style="margin-top:10px;" type="file" accept="image/*" name="answer_5_media" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            <div>
                ...
                <input style="margin-top:10px;" type="file" accept="image/*" name="answer_6_media" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
...
{{--  --}}
<form action="{{route('fmt.mcqpan.csv')}}" method="POST" enctype='multipart/form-data' style="margin:20px 40px;">
    @csrf
    <input type="integer" name="problem_set_id" value="{{$pbs72 ?? ''}}" hidden style="border:1px solid #000000;">
    <input type="integer" name="format_type_id" value="{{$fmt72 ?? ''}}" hidden style="border:1px solid #000000;">
